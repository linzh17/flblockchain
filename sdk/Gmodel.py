...
class Gmodel(object):
    def __init__(self, contract_name = 'gmodel', sol_file=path+'gmodel.sol', abi_file=path+'gmodel.abi', bin_file=path+'gmodel.bin'):
        ...
        if result is False:
            ...
            print(self.contractManager.getContractInfo(self.contractAddress))
    ...
    def get_weight(self):
        ...
        try:
            ...
            response = self.contractManager.call(self.contractAddress, self.contract_abi, "get_weight", args)
            return response
        except:
            traceback.print_exc()
            return None
